        ...
        messages: [
            {
                ...
                El formato de salida debe de ser un JSON con las siguientes propiedades:

                {
                    "userScore": number, // Valor entre 0 y 100
                    "errors": [
                    "error - corrección",
                    ],
                    "message": "Tu respuesta, junto con la frase corregida si es necesario"
                }
